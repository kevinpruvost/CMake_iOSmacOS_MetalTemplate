...
| **`include_xcode_bundle_resource_files(target, resource_files, resource_dir)`** | Adds **bundle resource files** to the Xcode project. The **difference** here is that here, these files are **Xcode resource files** and so they will need other treatments, check the code difference for better understanding.                                                                                                                                                                       |
